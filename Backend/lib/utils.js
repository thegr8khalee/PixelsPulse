...
export const sendWelcomeEmail = async (recipientEmail) => {
  const mailOptions = {
    from: '"PixelsPulse Newsletter" <YOUR_EMAIL@gmail.com>',
    to: recipientEmail,
...
If you wish to unsubscribe, click here: https://pixelspulse.dev/unsubscribe?email=${encodeURIComponent(
      recipientEmail
    )}
      ...
      <tr>
        <td style="background: #0a0a23; color: #ffffff; text-align: center; padding: 20px; font-size: 12px;">
          ...
          <p style="margin: 5px 0 10px">
            <a href="mailto:pixelspulsedev@gmail.com" style="color: #30d5f3; text-decoration: none">
              pixelspulsedev@gmail.com
            </a>
          </p>

          <!-- UNSUBSCRIBE BUTTON -->
          <a href="https://pixelspulse.dev/api/newsletter/unsubscribe/${encodeURIComponent(
            recipientEmail
          )}" target="_blank"
