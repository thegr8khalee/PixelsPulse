...
const GlassmorphicHero = () => {
  ...
  return (
    <div className='flex items-center justify-center px-4 sm:px-6 lg:px-16 w-screen h-screen'>
      <div className='relative z-10 w-full max-w-7xl flex items-center h-full py-10'>
        {/* Main Glass Card - now with min-height */}
        <motion.div
          className='backdrop-blur-xl bg-white/5 rounded-3xl py-8 px-4 sm:p-12 lg:p-16 lg:px-24 border-hidden shadow-2xl flex flex-col md:flex-row items-center gap-8 lg:gap-16 w-full h-full my-20 justify-between'
          initial={{
            opacity: 0,
          }}
